...
var g_levelMap =[                                 // 7   8
                ...
                ["m", "f", "m", "f", "m", "f", "m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "m"], //9
                ["m", "f", "f", "f", "m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "m"], //10
                ["m", "f", "m", "f", "m", "f", "m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "m"], //11
                ["m", "f", "m", "f", "f", "f", "m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "m"], //12
                ["m", "f", "m", "f", "m", "f", "m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "m"], //13
                ["m", "f", "f", "f", "m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "m"], //14
                ["m", "f", "m", "m", "m", "m", "m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "m"], //15
                ["m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "m"], //16
                ["m", "f", "g", "f", "m", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "g", "f", "m"], //17
